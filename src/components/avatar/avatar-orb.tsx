...
export function AvatarOrb({ state, volume, frequencyData, isSpeaking }: AvatarOrbProps) {
  ...
  const particleCount = isThinking ? 24 : isActive ? 16 : 8;
  const particleSpeed = isThinking ? 2 : isActive ? 4 : 8;
